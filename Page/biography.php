...
<head lang="en">
    ...
    <title>Biography | Nevyllo Kalangi</title>
    <!-- HTML Config -->
    <!-- HTML Links -->
                ...
                <div class="biography-section">
                    ...
                    <div class="biography-container">
                        <div class="biography-content">
                            ...
                            <div class="biography-heading">Elementary School</div>
                            <p class="biography-desc">In 2018, I graduated from Kidsstar Elementary School and I chose to study at Dunia Harapan Secondary School. Also this year I started to develop my coding skills by joining the coding extracurricular. C++ is the first programming language I learned.</p>
                        </div>
                        <div class="biography-content">
                        ...
                        <div class="biography-content">
                            ...
                            <div class="biography-heading">Member of Sport & Art Division</div>
                            <p class="biography-desc">When I was in grade 10, my friend initiated me to participate in the election for student council president. I became the vice president candidate and my partner was the president candidate. Unfortunately, we lost the election and our senior became the president. I was chosen to be the member of Dunia Harapan High School Student Council Sport & Art Division by my senior.</p>
                        </div>
                        <div class="biography-content">
                        ...
                        <div class="biography-content">
                            ...
                            <div class="biography-heading">President Student Council</div>
                            <p class="biography-desc">In 2022, I was elected as the president of Dunia Harapan High School Student Council</p>
                        </div>
                        <div class="biography-content">
                            <div class="biography-year">2024</div>
                            <div class="biography-heading">High School</div>
                            <p class="biography-desc">In 2024, I graduated from Dunia Harapan High School.</p>
                        </div>
                    </div>
                </div>
                <div class="biography-section">
                    ...
                    <div class="biography-container">
                        <div class="biography-content">
                            ...
                            <div class="biography-heading">Bachelor of Computer Science</div>
                            <p class="biography-desc">This only for a new section for my biography. I'm not Bachelor of Computer Science.</p>
                        </div>
                    </div>
                </div>
            </div>
